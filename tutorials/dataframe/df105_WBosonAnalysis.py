...
parser.add_argument("--lumi-scale", type=float, default=0.01, help="Scale of the overall lumi of 10 fb^-1")
args = parser.parse_args()

# Create a ROOT dataframe for each dataset
# Note that we load the filenames from a json file, which you can find in the same directory than this script.
path = "root://eospublic.cern.ch//eos/opendata/atlas/OutreachDatasets/2020-01-22"
files = json.load(open("df105_WBosonAnalysis.json"))
