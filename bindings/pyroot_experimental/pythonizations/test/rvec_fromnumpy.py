...
class RVecFromNumpy(unittest.TestCase):
    """
    Tests for the RVec.FromNumpy feature enabling to adopt memory of Python objects
    ...
    def test_dtypes(self):
        ...
        for dtype in self.dtypes:
            ...
            root_obj = ROOT.ROOT.VecOps.RVec.FromNumpy(np_obj)
    ...
    def test_multidim(self):
        ...
        rvec = ROOT.ROOT.VecOps.RVec.FromNumpy(np_obj)
    ...
    def test_adopt_rvec(self):
        ...
        rvec[0] = 42
        rvec2 = ROOT.ROOT.VecOps.RVec.FromNumpy(rvec)
